...
def predict_stuff():
    if request.method == 'POST':
        ...
        print("has_fireplace: ",has_fireplace)
        print("has_pool: ",has_pool)
        print("has_central_heating: ",has_central_heating)
        print("has_central_cooling: ",has_central_cooling)
        ...
        # scikit-learn assumes you want to predict the values for lots of houses at once, 
        ...
        print("homes_to_value: ",homes_to_value )

        # Run the model and make a prediction for each house in the homes_to_value array
        predicted_home_values = model.predict(homes_to_value)

        print("predicted_home_values: ",predicted_home_values)
